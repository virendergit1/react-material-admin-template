...
class ManageVisitorForm extends React.Component {

    componentDidMount() {
        this.refs.manageVisitororPhone            // the Field
    ...
    render() {
        ...
        <form onSubmit={handleSubmit}>
            <div style={styles.subheading}>Setup Temporary Visitors</div>
...
export default reduxForm({
  form: 'ManageVisitorForm',  // a unique identifier for this form
  validate,
  initialValues: {
    gender: 'male',
  }
